//
//  WBYaaFenzhijigouViewController.m
//  whm_project
//
...
@interface WBYaaFenzhijigouViewController ()<UITableViewDelegate,UITableViewDataSource,CMIndexBarDelegate>
{
    UIView * gongsiView;
...
@end
@implementation WBYaaFenzhijigouViewController
...
-(void)creatupView
{
    ...
    [myTab registerClass:[WHorginTableViewCell class] forCellReuseIdentifier:@"cell"];
    myTab.rowHeight = 90;
...
-(void)requestBaoXianGongSi
{
    ...
    [dic setObject:[WBYRequest jiami:@"kb/get_org_com"] forKey:@"kb"];
    [dic setObject:@"" forKey:@"keyword"];
    
    [WBYRequest wbyPostRequestDataUrl:@"kb/get_org_com" addParameters:dic success:^(WBYReqModel *model)
     {
