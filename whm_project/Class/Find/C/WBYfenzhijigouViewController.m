//
//  WBYfenzhijigouViewController.m
//  whm_project
//
...
@interface WBYfenzhijigouViewController ()<UITableViewDelegate,UITableViewDataSource,BMKMapViewDelegate,BMKLocationServiceDelegate>
{
...
@implementation WBYfenzhijigouViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"分支机构位置";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WBYFzljghViewController * wby = [WBYFzljghViewController new];
    wby.myDataModel = mod;
