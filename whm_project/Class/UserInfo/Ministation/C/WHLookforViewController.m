...
-(void)setData
{
    ...
    __weak WHLookforViewController * mySelf  = self;
    id hud = [JGProgressHelper showProgressInView:self.view];
         ...
         if (lists.count >= 1)
         {
             ...
             if (model.agent_info.count >= 1)
             {
                 ...
                 mySelf.companyLaber.text = [NSString stringWithFormat:@"%@%@%@%@",info.cname,info.profession,info.work_time,info.service_area];
                   ...
                   //mySelf.areaLaber.text = info.service_area;
                
//                 mySelf.area.text = info.area_info;
//                 mySelf.address.text = info.job_address;
//                 mySelf.exhibition_no.text = info.exhibition_no;
//                 mySelf.certificate_no.text = info.certificate_no;
//                 mySelf.oname.text = info.oname;
//                 mySelf.company.text = info.cname;
...
-(void)setupUI
{
    self.tableV = [[UITableView alloc] initWithFrame:CGRectMake(0, kScreenHeight* 0.25, kScreenWitdh, kScreenHeight*0.75 - 64) style:UITableViewStylePlain];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0 ) {
        ...
        Laber1.frame = CGRectMake(30, 5, wScreenW * 0.5, 30);
        Laber1.text = @"基本信息";
        ...
        }else
        {
         ...
         xiaBut.tag = 100;
        [xiaBut addTarget:self action:@selector(aafirest:) forControlEvents:(UIControlEventTouchUpInside)];
...
-(void)aafirest:(UIButton *)aBtn
{
//    if (self.section == aBtn.tag - 100+ 1) {
//        self.section = 0;
//        floag = YES;
//    }
//    else
//    {
//        self.section = aBtn.tag - 100 +1;
//      floag = NO;
//    }
//    
