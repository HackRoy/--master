...
@interface WHinsuranceViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDataSource,UICollectionViewDelegate,CMIndexBarDelegate>
{
    CMIndexBar *indexBar;
}
...
@implementation WHinsuranceViewController
...
-(void)getData
{
    ...
    [self.dataService get_CompanysWithType:@"1,2" success:^(NSArray *lists) {
        ...
        NSArray * ary = @[@"热",@"A",@"B",@"C",@"D",@"E",@"F",@"G",@"H",@"I",@"J",@"Q",@"L",@"M",@"N",@"O",@"P",@"Q",@"R",@"S",@"T",@"U",@"V",@"W",@"X",@"Y",@"Z"];
