...
@implementation WHcounselTableViewCell

-(UIImageView *)myImg
{
    if (_myImg == nil) {
        self.myImg = [[UIImageView alloc]init];
        self.myImg.frame = CGRectMake(10, 10,kScreenWitdh * 0.25 , kScreenWitdh * 0.25);
...
-(UILabel *)readNum
{
    if (_readNum == nil) {
        ...
        self.readNum.frame = CGRectMake(CGRectGetMinX(self.myTit.frame), CGRectGetMaxY(self.myTit.frame)+5, kScreenWitdh * 0.2, 20);
        self.readNum.textColor = [UIColor grayColor];
        self.readNum.font = [UIFont systemFontOfSize:11.0];
...
-(UILabel *)styLaber
{
    if (_styLaber == nil) {
        ...
        self.styLaber.frame = CGRectMake(CGRectGetMaxX(self.readNum.frame)+3, CGRectGetMinY(self.readNum.frame), kScreenWitdh * 0.25, 20);
        self.styLaber.textColor = [UIColor grayColor];
        self.styLaber.font = [UIFont systemFontOfSize:11.0];
...
-(UILabel *)timeLaber
{
    if (_timeLaber == nil) {
        ...
        self.timeLaber.frame = CGRectMake(kScreenWitdh * 0.75, CGRectGetMinY(self.readNum.frame), kScreenWitdh*0.2, 20);
        self.timeLaber.font = [UIFont systemFontOfSize:11.0];
