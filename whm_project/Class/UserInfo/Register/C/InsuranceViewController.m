...
-(void)getData
{
    ...
    //所有公司
    [self.dataService get_CompanysWithType:self.completeId?self.completeId:@"" success:^(NSArray *lists)
    {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [_delegate comNamepleteId:model.id completeName:model.name];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.completeLab.font = [UIFont systemFontOfSize:12];
    cell.completeLab.numberOfLines = 0;
